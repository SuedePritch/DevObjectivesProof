...
var createLeadsquared = asyncHandler( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, companyName, accessKey, secretKey, leadsquared;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body = req.body, companyName = _req$body.companyName, accessKey = _req$body.accessKey, secretKey = _req$body.secretKey;
          _context.next = 3;
...
//POST /users
//ACCESS PUBLIC
var signupUser = asyncHandler( /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body, username, email, password, userExists, salt, hashedPassword, user, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
...
//GET /users/me
//ACCESS PRIVATE
var getMyUser = asyncHandler( /*#__PURE__*/function () {
...
var updateMyUser = asyncHandler( /*#__PURE__*/function () {
...
var deleteMyUser = asyncHandler( /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res, next) {
    var email, user;
...
User.find({}).exec(function (err, collection) {
  if (collection.length === 0) {
    User.create({
      ...
      return err ? handleError(err) : console.log("Created new document");
    });
  }
});
module.exports = User;
...
db.once("open", function () {
  app.listen(PORT, function () {
    console.log(colors.bgBlue("--API Running on PORT "), colors.green(PORT), colors.bgBlue("----"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          //Verify token
          decoded = jwt.verify(token, process.env.JWT_SECRET); //Get user from the token
          _context.next = 6;
